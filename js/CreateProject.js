...
function AddMarker() {
    $.ajax({
        type: "POST",
        url: "CreateProject.aspx/SaveProject",
    ...
    function DataList() {
        $.ajax({
            type: "POST",
            url: "CreateProject.aspx/GetData",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            cache: false,
    ...
    function setmarker() {
        ...
        $.ajax({
            type: "POST",
            url: "CreateProject.aspx/GetMarker",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            cache: false,
...
function Save() {
    ...
    $.ajax({
        type: "POST",
        url: "CreateProject.aspx/SaveData",
        contentType: "application/json; charset=utf-8",
...
function EditData() {
    ...
    $.ajax({
        type: "POST",
        url: "CreateProject.aspx/EditData",
        contentType: "application/json; charset=utf-8",
...
function DeletePoint(id) {
    swal({
       ...
       function () {
           $.ajax({
               type: "POST",
               url: "CreateProject.aspx/DeleteData",
               contentType: "application/json; charset=utf-8",
